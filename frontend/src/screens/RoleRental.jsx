...
const RoleRental = () => {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            setError(err.message || 'Não foi possível carregar os artigos para aluguer.');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="inventory-page">
            ...
            {loading ? (
                <section className="inventory-card inventory-empty">
                    <p>A carregar artigos para aluguer...</p>
                </section>
                    ...
                    <section className="inventory-modal" onClick={(event) => event.stopPropagation()}>
                        ...
                        <div className="inventory-form-note">
                            ...
                            <div className="inventory-role-detail-grid">
                                ...
                                <div className="inventory-meta-row">
                                    <span>Email responsável</span>
                                    <strong>{selectedItem.Criador?.Email || 'Sem registo'}</strong>
                                </div>
                            </div>
                        </div>
                    </section>
